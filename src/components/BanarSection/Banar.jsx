...
const Banar = () => {
    return (
        <div className='flex flex-col gap-4 md:flex-row w-11/12 mx-auto justify-between items-center p-5 mt-15 border mb-10'>
            <div className='container-left  space-y-3'>
                <h2 className='rounded-3xl bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent p-3'><FaRegDotCircle></FaRegDotCircle> New: AI-Powered Tools Available</h2>
